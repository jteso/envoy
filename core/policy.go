...
func (bm ModuleWrapper) GetModule() Module {
	return bm.module
}

func NewModuleWrapper(moduleName string, params ModuleParams) *ModuleWrapper {
	return &ModuleWrapper{
		moduleName: moduleName,
		module:     GetModule(moduleName, params),
	}
}
...
func (p1 *Policy) GetModule(priority int) Module {
